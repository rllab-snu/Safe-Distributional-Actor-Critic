...
extern "C" {
    ...
    void projection2(int n_quantiles1, double weight1, double* quantiles1, int n_quantiles2, double weight2, double* quantiles2, int n_quantiles3, double* new_quantiles){
        /* 
            different numbers of quanitles.
            should be "n_quantiles1 <= n_quantiles2".
            interpolation: linear 
