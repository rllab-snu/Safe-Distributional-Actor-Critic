...
from utils.cassie_env.env_v0 import Env as OriginalEnv
...
class Env(OriginalEnv):
    def __init__(self, use_fixed_base=False, init_base_pos=[0.0, 0.0, 1.0], init_base_quat=[1.0, 0.0, 0.0, 0.0], max_episode_length=1000, lam1=0, lam2=0, lam3=0) -> None:
